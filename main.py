...
def database_president(vin, user_choice):
        ...
        con.commit()
        messagebox.showerror("success","You have succesfully voted")
        con.close()
...
def database_governor(vin, user_choice):
        ...
        con.commit()
        messagebox.showinfo("success","You have succesfully voted")
        con.close()
...
def component_widget_1():
        ...
        LP_Vote= ImageTk.PhotoImage(Image.open(r"C:\Users\DAVID OSH\Desktop\THE STRINGS PROJECT\My voting App\LP.png").resize((60,60),Image.LANCZOS))
        ...
        PDP_Vote= ImageTk.PhotoImage(Image.open(r"C:\Users\DAVID OSH\Desktop\THE STRINGS PROJECT\My voting App\PDP.png").resize((60,60),Image.LANCZOS))
        ...
        APC_Vote= ImageTk.PhotoImage(Image.open(r"C:\Users\DAVID OSH\Desktop\THE STRINGS PROJECT\My voting App\APC.png").resize((60,60),Image.LANCZOS))
        ...
        NNPP_Vote= ImageTk.PhotoImage(Image.open(r"C:\Users\DAVID OSH\Desktop\THE STRINGS PROJECT\My voting App\nnpp.png").resize((60,60),Image.LANCZOS))
...
if __name__=="__main__":
    ...
    root.iconbitmap(r'C:\Users\DAVID OSH\Desktop\THE STRINGS PROJECT\My voting App\String_logo.ico')
    root.resizable(0,0)
    root.title("The Strings Voting App")
    root.config(background="#000E0E")
    img1 = ImageTk.PhotoImage(Image.open(r"C:\Users\DAVID OSH\Desktop\THE STRINGS PROJECT\My voting App\pattern.png"))
